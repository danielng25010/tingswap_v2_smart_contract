...
import { expandTo18Decimals, TingswapVersion } from "./shared/utilities";

const TOTAL_SUPPLY = expandTo18Decimals(10000);
const TEST_AMOUNT = expandTo18Decimals(10);

describe("TingswapV2ERC20", () => {
  ...
  it("name, symbol, decimals, totalSupply, balanceOf, DOMAIN_SEPARATOR, PERMIT_TYPEHASH", async () => {
    ...
    expect(name).to.eq("Tingswap V2");
    expect(await token.symbol()).to.eq("TING-V2");
      ...
      ethers.keccak256(
        ethers.AbiCoder.defaultAbiCoder().encode(
          ...
          [
            ...
            ethers.keccak256(ethers.toUtf8Bytes(TingswapVersion)),
            chainId,
